      ...
      <div className="block_row">
        <div className="block_column">
          <div className="block_info">
            ...
            <p>Привет, меня зовут Максим, веб—разработкой заинтересовался в 2011 году. 
               Изучил варианты и для старта выбрал WordPress, а в процессе освоил HTML, CSS.</p>
            <p>Далее узнал про SEO и начал продвигать сайты. Устроился на работу в веб—студию. 
